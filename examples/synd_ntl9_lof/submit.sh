...
CONFIG_FILE=/thfs3/home/sysu__netlab/xlc_DL_lab/packages/deepdrivewe/examples/synd_ntl9_lof/config.yaml

# Run the example
echo "start run the example"
python -m deepdrivewe.examples.synd_ntl9_lof.main --config $CONFIG_FILE
