...
CONFIG_FILE=/thfs3/home/sysu__netlab/xlc_DL_lab/packages/deepdrivewe/examples/amber_nacl_hk/config.yaml

# Run the example
echo "start run the example"
python -m deepdrivewe.examples.amber_nacl_hk.main --config $CONFIG_FILE
